...
export class HomeTrustComponent {
 ...
 readonly partners:Partner[]=[
  {name:'CONTABO',alt:'CONTABO',href:'https://my.contabo.com/account/login',img:'images/logos/contabo.svg',initials:'CT',c1:'#0f9b8e',c2:'#0b5f57'},
  {name:'DESJARDINS',alt:'Desjardins',href:'https://www.desjardins.com/qc/fr.html',img:'images/logos/desjardins.svg',initials:'DJ',c1:'#12864a',c2:'#0b5c33'},
  {name:'CAMCCUL',alt:'CAMCCUL',href:'https://camccul.cm',img:'images/logos/camccul.png',initials:'CC',c1:'#1a4f9c',c2:'#0d2b4a'},
  {name:'OMOA',alt:'OMOA',href:'https://www.omoa-group.com',img:'images/logos/omoa.svg',initials:'OM',c1:'#f2a11e',c2:'#c07407'}
 ];
